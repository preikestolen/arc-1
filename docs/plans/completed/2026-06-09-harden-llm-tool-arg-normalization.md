...
- [ ] `docs_page/roadmap.md` and `docs/compare/00-feature-matrix.md`: add/refresh a row for "Robust against GPT/OpenAI schema over-population" (✅) and update the "Last Updated" date in the feature matrix.
