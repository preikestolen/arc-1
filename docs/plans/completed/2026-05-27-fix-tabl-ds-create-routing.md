...
- Docs: `docs/research/abap-types/types/tabl.md` updated with the create-side fix verdict and live evidence; `CLAUDE.md` Key Files table gains a row; `docs/compare/00-feature-matrix.md` "Table write (TABL)" row gets an inline note that ARC-1 now also creates TABL/DS structures.
...
| `docs/research/abap-types/types/tabl.md` | Add a "Create-path routing (TABL/DT vs TABL/DS)" section documenting the post-fix behavior with live evidence. |
...
| `docs/compare/00-feature-matrix.md` | Update the "Table write (TABL)" row to note ARC-1 supports both TABL/DT and TABL/DS create after this fix; refresh "Last Updated". |
...
- [x] Move this plan to `docs/plans/completed/2026-05-27-fix-tabl-ds-create-routing.md`
