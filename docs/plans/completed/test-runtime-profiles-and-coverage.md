...
| `docs/research/test-suite-audit-2026-05-11.md` | Mark implemented runtime/coverage items and record validation. |
| `docs/research/test-runtime-profiles-and-coverage-2026-06-06.md` | Keep implementation status and new findings current. |
...
- Modify: `docs/research/test-runtime-profiles-and-coverage-2026-06-06.md`
- Modify: `CLAUDE.md`
- Move: `docs/plans/test-runtime-profiles-and-coverage.md` to `docs/plans/completed/test-runtime-profiles-and-coverage.md` after implementation and validation.
...
- [x] Update `docs/research/test-suite-audit-2026-05-11.md` Recommended Work Items / Implemented Follow-ups to mark items 8, 9, 10, 11, 12, 13, 14, and 15 as implemented or partially implemented by this PR.
- [x] Update `docs/research/test-runtime-profiles-and-coverage-2026-06-06.md` with final implementation details, measured local/SAP runtimes, test results, and any new findings.
...
- [x] Move this plan to `docs/plans/completed/test-runtime-profiles-and-coverage.md`.
