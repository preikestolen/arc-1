...
- Documentation updated: `docs/tools.md`, `docs/roadmap.md`, `docs/compare/00-feature-matrix.md`, `CLAUDE.md`
...
| `docs/compare/00-feature-matrix.md` | Update fix proposals row |
...
- [ ] Verify documentation is consistent across `docs/tools.md`, `docs/roadmap.md`, `docs/compare/00-feature-matrix.md`
