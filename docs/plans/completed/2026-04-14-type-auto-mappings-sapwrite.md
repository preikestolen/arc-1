...
- Dassian-adt has 16 type auto-mappings in `abap_create`. The `docs/compare/00-feature-matrix.md` row for "Type auto-mappings" shows ARC-1 as ❌.
...
- The `docs/compare/00-feature-matrix.md` row updated to ✅.
...
| `docs/compare/00-feature-matrix.md` | Feature matrix — update row |
...
- [ ] In `docs/compare/00-feature-matrix.md`, update the "Type auto-mappings (CLAS→CLAS/OC)" row: change ARC-1 from ❌ to ✅
