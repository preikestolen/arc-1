...
- Clear failure message: "<file> is N lines, budget B — split it (see docs/plans/completed/2026-06-11-architecture-consolidation-plan.md) or consciously raise its budget in this script."
