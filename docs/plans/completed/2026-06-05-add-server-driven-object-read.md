...
This is item #2 from `docs/research/2026-06-05-abap-platform-2025-new-adt-apis.md` (§4 / §6). The mandatory spike is **done** — see "Verified Live Evidence" — so the wire contract, the discovery gate, and real 200 round-trips against two high-value dev types (DESD, EVTB) are confirmed, not assumed.
...
**Files:**
- Modify: `docs_page/tools.md`, `CLAUDE.md`, `docs/research/2026-06-05-abap-platform-2025-new-adt-apis.md`, `docs_page/roadmap.md`, `docs/compare/00-feature-matrix.md`
...
- [ ] `docs/research/2026-06-05-abap-platform-2025-new-adt-apis.md`: mark §4 / §6 #2 **implemented** (read path) with the verified instance names; note write is the remaining follow-up.
- [ ] `docs_page/roadmap.md`: add a completed row. `docs/compare/00-feature-matrix.md`: add/refresh a row if one fits; refresh "Last updated".
