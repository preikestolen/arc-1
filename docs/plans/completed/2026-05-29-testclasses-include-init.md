...
- [ ] `docs/compare/00-feature-matrix.md`: prepend a dated note (testclasses/CCAU include auto-init on write) and bump "Last Updated"; `docs_page/roadmap.md`: extend the relevant CLAS-write entry.
...
- [ ] Move this plan to `docs/plans/completed/2026-05-29-testclasses-include-init.md`
