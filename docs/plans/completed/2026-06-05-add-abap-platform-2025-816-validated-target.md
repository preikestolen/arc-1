...
- Docs reference only "758 for S/4HANA 2023": `CLAUDE.md` (config table row for
  ...
  has per-system skip-profile tables (no 2025 row); `docs/research/abap-types/00-methodology.md`
...
| `docs/research/abap-types/00-methodology.md` | Test-system inventory |
...
- Modify: `docs/research/abap-types/00-methodology.md`
...
- [ ] `docs/research/abap-types/00-methodology.md`: change the 2-system inventory to 3 systems — add
